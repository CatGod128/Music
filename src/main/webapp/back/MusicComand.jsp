...
<body>
	<form class="form-horizontal" enctype="multipart/form-data" action="ajax/saveMusic"method="Post">
		<div class="container">
			<!--下拉框-->
 ...
 <div class="row form-group">
   <label class="checkbox-inline">
      <input type="checkbox" id="inlineCheckbox3" value="option1"> 流行   
    </label>
    <label class="checkbox-inline">
      <input type="checkbox" id="inlineCheckbox3" value="option2"> 安静   
    </label>
    <label class="checkbox-inline">
      <input type="checkbox" id="inlineCheckbox3" value="option3"> 摇滚   
    </label>
    <label class="checkbox-inline">
      <input type="checkbox" id="inlineCheckbox3" value="option3"> 古典   
    </label>
 </div>
			...
			<div class="row form-group">
				...
				<div class="col-lg-5 col-md-6">
                   <input id="myFile" type="file" name="Mfiles" multiple class="file-loading">
				</div>
			</div>
			<div class="row form-group">
			...
			<div class="row form-group ">
				<div class="input-group">
					<span class="input-group-addon">歌手性别</span> 
